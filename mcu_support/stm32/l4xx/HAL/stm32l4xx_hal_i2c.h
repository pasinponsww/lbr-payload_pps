...
#define HAL_I2C_ERROR_INVALID_PARAM \
  ...
  */
    typedef struct __I2C_HandleTypeDef
    {
        ...
        __IO uint16_t
            XferCount; /*!< I2C transfer counter                      */
        ...
        DMA_HandleTypeDef*
            hdmatx; /*!< I2C Tx DMA handle parameters              */

        DMA_HandleTypeDef*
            hdmarx; /*!< I2C Rx DMA handle parameters              */
        ...
        __IO uint32_t
            Memaddress; /*!< I2C Target memory address                 */
