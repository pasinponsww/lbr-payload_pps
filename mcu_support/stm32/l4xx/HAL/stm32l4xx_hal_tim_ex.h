...
#define TIM_TIM2_TI4_COMP1_COMP2 \
    (TIM2_OR1_TI4_RMP_1 |        \
     TIM2_OR1_TI4_RMP_0) /*!< TIM2 TI4 is connected to logical OR between COMP1 and COMP2 output2 */
#endif /* COMP2 */
...
#define TIM_TIM3_TI1_COMP1_COMP2 \
    (TIM3_OR1_TI1_RMP_1 |        \
     TIM3_OR1_TI1_RMP_0) /*!< TIM3 TI1 is connected to logical OR between COMP1 and COMP2 output2 */
...
#define TIM_TIM15_ENCODERMODE_TIM2 \
    TIM15_OR1_ENCODER_MODE_0 /*!< TIM2 IC1 and TIM2 IC2 are connected to TIM15 IC1 and TIM15 IC2 respectively */
#if defined(TIM3)
#define TIM_TIM15_ENCODERMODE_TIM3 \
    TIM15_OR1_ENCODER_MODE_1 /*!< TIM3 IC1 and TIM3 IC2 are connected to TIM15 IC1 and TIM15 IC2 respectively */
#endif                       /* TIM3 */
#if defined(TIM4)
#define TIM_TIM15_ENCODERMODE_TIM4 \
    (TIM15_OR1_ENCODER_MODE_1 |    \
     TIM15_OR1_ENCODER_MODE_0) /*!< TIM4 IC1 and TIM4 IC2 are connected to TIM15 IC1 and TIM15 IC2 respectively */
#endif                         /* TIM4 */
...
#define TIM_TIM16_TI1_RTC  \
    (TIM16_OR1_TI1_RMP_1 | \
     TIM16_OR1_TI1_RMP_0) /*!< TIM16 TI1 is connected to RTC wakeup interrupt */
...
#define TIM_BREAKINPUTSOURCE_DFSDM1 \
    0x00000008U /*!< The analog watchdog output of the DFSDM1 peripheral is connected to the break input */
...
#define IS_TIM_BREAKINPUTSOURCE_POLARITY(__POLARITY__)        \
  ...
  */
    ...
    HAL_StatusTypeDef HAL_TIMEx_ConfigCommutEvent_IT(
        TIM_HandleTypeDef* htim, uint32_t InputTrigger,
        uint32_t CommutationSource);
