...
#include "stm32f4xx_hal_def.h"
  ...
  */
    typedef struct
    {
        ...
        uint8_t
            USERConfig; /*!< Program the FLASH User Option Byte: IWDG_SW / RST_STOP / RST_STDBY. */
...
/**
  ...
  */
    ...
    defined(STM32F439xx) || defined(STM32F469xx) || defined(STM32F479xx)
        ...
        uint16_t
            SectorsBank1; /*!< Specifies the sector(s) set for PCROP for Bank1.
                                This parameter can be a value of @ref FLASHEx_Option_Bytes_PC_ReadWrite_Protection */

        uint16_t
            SectorsBank2; /*!< Specifies the sector(s) set for PCROP for Bank2.
                                This parameter can be a value of @ref FLASHEx_Option_Bytes_PC_ReadWrite_Protection */
